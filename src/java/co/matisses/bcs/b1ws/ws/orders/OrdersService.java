 ...
 * 
 */
@WebServiceClient(name = "OrdersService", targetNamespace = "OrdersService", wsdlLocation = "http://192.168.5.75/B1WS/WebReferences/OrdersService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.5.75/B1WS/WebReferences/OrdersService.wsdl");

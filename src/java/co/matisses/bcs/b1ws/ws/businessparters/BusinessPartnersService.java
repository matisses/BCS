 ...
 * 
 */
@WebServiceClient(name = "BusinessPartnersService", targetNamespace = "BusinessPartnersService", wsdlLocation = "http://192.168.5.75/B1WS/WebReferences/BusinessPartnersService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.5.75/B1WS/WebReferences/BusinessPartnersService.wsdl");

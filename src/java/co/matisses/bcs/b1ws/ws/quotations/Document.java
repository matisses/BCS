 ...
 *         &lt;element name="U_ImprimirFactura" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="U_PrestashopID" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
public class Document {
    ...
    @XmlElement(namespace = "", name = "PrintSEPADirect")
    protected String printSEPADirect;
    @XmlElement(namespace = "", name = "FiscalDocNum")
    protected String fiscalDocNum;
    @XmlElement(namespace = "", name = "POSDailySummaryNo")
    protected Long posDailySummaryNo;
    @XmlElement(namespace = "", name = "POSReceiptNo")
    protected Long posReceiptNo;
    @XmlElement(namespace = "", name = "PointOfIssueCode")
    protected String pointOfIssueCode;
    @XmlElement(namespace = "", name = "Letter")
    protected String letter;
    @XmlElement(namespace = "", name = "FolioNumberFrom")
    protected Long folioNumberFrom;
    @XmlElement(namespace = "", name = "FolioNumberTo")
    protected Long folioNumberTo;
    @XmlElement(namespace = "", name = "InterimType")
    protected String interimType;
    @XmlElement(namespace = "", name = "RelatedType")
    protected Long relatedType;
    @XmlElement(namespace = "", name = "RelatedEntry")
    ...
    @XmlElement(namespace = "", name = "U_ImprimirFactura")
    protected String uImprimirFactura;
    @XmlElement(namespace = "", name = "U_PrestashopID")
    protected String uPrestashopID;
    ...
    /**
     * Obtiene el valor de la propiedad uImprimirFactura.
     *
     * @return possible object is {@link String }
     *
     */
    public String getUImprimirFactura() {
        return uImprimirFactura;
    }

    /**
     * Define el valor de la propiedad uImprimirFactura.
     *
     * @param value allowed object is {@link String }
     *
     */
    public void setUImprimirFactura(String value) {
        this.uImprimirFactura = value;
    }

    /**
     * Obtiene el valor de la propiedad uPrestashopID.
     *
     * @return possible object is {@link String }
     *
     */
    public String getUPrestashopID() {
        return uPrestashopID;
    }

    /**
     * Define el valor de la propiedad uPrestashopID.
     *
     * @param value allowed object is {@link String }
     *
     */
    public void setUPrestashopID(String value) {
        this.uPrestashopID = value;
    }
    ...
    public static class AddressExtension {
        ...
        @XmlElement(namespace = "", name = "ShipToAddress2")
        protected String shipToAddress2;
        @XmlElement(namespace = "", name = "ShipToAddress3")
        protected String shipToAddress3;
        @XmlElement(namespace = "", name = "BillToAddress2")
        protected String billToAddress2;
        @XmlElement(namespace = "", name = "BillToAddress3")
    ...
    public static class DocumentLines {
        ...
        public static class DocumentLine {
            ...
            @XmlElement(namespace = "", name = "ThirdParty")
            ...
            @XmlElement(namespace = "", name = "ParentLineNum")
            ...
            @XmlElement(namespace = "", name = "ItemType")
            protected String itemType;
            @XmlElement(namespace = "", name = "ChangeInventoryQuantityIndependently")
            protected String changeInventoryQuantityIndependently;
            @XmlElement(namespace = "", name = "FreeOfChargeBP")
            ...
            public String toString() {
                return "DocumentLine{" + "lineNum=" + lineNum + ", itemCode=" + itemCode + ", unitPrice=" + unitPrice + '}';
            }
        }
    ...
    public static class TaxExtension {
        ...
        @XmlElement(namespace = "", name = "TaxId12")
        protected String taxId12;
        @XmlElement(namespace = "", name = "TaxId13")
    ...
    @Override
    public String toString() {
        return "Document{" + "docEntry=" + docEntry + ", docNum=" + docNum + ", docType=" + docType + ", handWritten=" + handWritten + ", printed=" + printed + ", docDate=" + docDate
                + ", docDueDate=" + docDueDate + ", cardCode=" + cardCode + ", cardName=" + cardName + ", address=" + address + ", numAtCard=" + numAtCard + ", docTotal=" + docTotal
                + ", attachmentEntry=" + attachmentEntry + ", docCurrency=" + docCurrency + ", docRate=" + docRate + ", reference1=" + reference1 + ", reference2=" + reference2
                + ", comments=" + comments + ", journalMemo=" + journalMemo + ", paymentGroupCode=" + paymentGroupCode + ", docTime=" + docTime + ", salesPersonCode=" + salesPersonCode
                + ", transportationCode=" + transportationCode + ", confirmed=" + confirmed + ", importFileNum=" + importFileNum + ", summeryType=" + summeryType
                + ", contactPersonCode=" + contactPersonCode + ", showSCN=" + showSCN + ", series=" + series + ", taxDate=" + taxDate + ", partialSupply=" + partialSupply
                + ", docObjectCode=" + docObjectCode + ", shipToCode=" + shipToCode + ", indicator=" + indicator + ", federalTaxID=" + federalTaxID + ", discountPercent=" + discountPercent
                + ", paymentReference=" + paymentReference + ", creationDate=" + creationDate + ", updateDate=" + updateDate + ", financialPeriod=" + financialPeriod + ", transNum=" + transNum
                + ", vatSum=" + vatSum + ", vatSumSys=" + vatSumSys + ", vatSumFc=" + vatSumFc + ", netProcedure=" + netProcedure + ", docTotalFc=" + docTotalFc
                + ", docTotalSys=" + docTotalSys + ", form1099=" + form1099 + ", box1099=" + box1099 + ", revisionPo=" + revisionPo + ", requriedDate=" + requriedDate
                + ", cancelDate=" + cancelDate + ", blockDunning=" + blockDunning + ", submitted=" + submitted + ", segment=" + segment + ", pickStatus=" + pickStatus + ", pick=" + pick
                + ", paymentMethod=" + paymentMethod + ", paymentBlock=" + paymentBlock + ", paymentBlockEntry=" + paymentBlockEntry + ", centralBankIndicator=" + centralBankIndicator
                + ", maximumCashDiscount=" + maximumCashDiscount + ", reserve=" + reserve + ", project=" + project + ", exemptionValidityDateFrom=" + exemptionValidityDateFrom
                + ", exemptionValidityDateTo=" + exemptionValidityDateTo + ", wareHouseUpdateType=" + wareHouseUpdateType + ", rounding=" + rounding
                + ", externalCorrectedDocNum=" + externalCorrectedDocNum + ", internalCorrectedDocNum=" + internalCorrectedDocNum + ", nextCorrectingDocument=" + nextCorrectingDocument
                + ", deferredTax=" + deferredTax + ", taxExemptionLetterNum=" + taxExemptionLetterNum + ", wtApplied=" + wtApplied + ", wtAppliedFC=" + wtAppliedFC
                + ", billOfExchangeReserved=" + billOfExchangeReserved + ", agentCode=" + agentCode + ", wtAppliedSC=" + wtAppliedSC + ", totalEqualizationTax=" + totalEqualizationTax
                + ", totalEqualizationTaxFC=" + totalEqualizationTaxFC + ", totalEqualizationTaxSC=" + totalEqualizationTaxSC + ", numberOfInstallments=" + numberOfInstallments
                + ", applyTaxOnFirstInstallment=" + applyTaxOnFirstInstallment + ", wtNonSubjectAmount=" + wtNonSubjectAmount + ", wtNonSubjectAmountSC=" + wtNonSubjectAmountSC
                + ", wtNonSubjectAmountFC=" + wtNonSubjectAmountFC + ", wtExemptedAmount=" + wtExemptedAmount + ", wtExemptedAmountSC=" + wtExemptedAmountSC
                + ", wtExemptedAmountFC=" + wtExemptedAmountFC + ", baseAmount=" + baseAmount + ", baseAmountSC=" + baseAmountSC + ", baseAmountFC=" + baseAmountFC + ", wtAmount=" + wtAmount
                + ", wtAmountSC=" + wtAmountSC + ", wtAmountFC=" + wtAmountFC + ", vatDate=" + vatDate + ", documentsOwner=" + documentsOwner + ", folioPrefixString=" + folioPrefixString
                + ", folioNumber=" + folioNumber + ", documentSubType=" + documentSubType + ", bpChannelCode=" + bpChannelCode + ", bpChannelContact=" + bpChannelContact
                + ", address2=" + address2 + ", documentStatus=" + documentStatus + ", periodIndicator=" + periodIndicator + ", payToCode=" + payToCode + ", manualNumber=" + manualNumber
                + ", useShpdGoodsAct=" + useShpdGoodsAct + ", isPayToBank=" + isPayToBank + ", payToBankCountry=" + payToBankCountry + ", payToBankCode=" + payToBankCode
                + ", payToBankAccountNo=" + payToBankAccountNo + ", payToBankBranch=" + payToBankBranch + ", bplidAssignedToInvoice=" + bplidAssignedToInvoice + ", downPayment=" + downPayment
                + ", reserveInvoice=" + reserveInvoice + ", languageCode=" + languageCode + ", trackingNumber=" + trackingNumber + ", pickRemark=" + pickRemark + ", closingDate=" + closingDate
                + ", sequenceCode=" + sequenceCode + ", sequenceSerial=" + sequenceSerial + ", seriesString=" + seriesString + ", subSeriesString=" + subSeriesString
                + ", sequenceModel=" + sequenceModel + ", useCorrectionVATGroup=" + useCorrectionVATGroup + ", totalDiscount=" + totalDiscount + ", downPaymentAmount=" + downPaymentAmount
                + ", downPaymentPercentage=" + downPaymentPercentage + ", downPaymentType=" + downPaymentType + ", downPaymentAmountSC=" + downPaymentAmountSC
                + ", downPaymentAmountFC=" + downPaymentAmountFC + ", vatPercent=" + vatPercent + ", serviceGrossProfitPercent=" + serviceGrossProfitPercent + ", openingRemarks=" + openingRemarks
                + ", closingRemarks=" + closingRemarks + ", roundingDiffAmount=" + roundingDiffAmount + ", roundingDiffAmountFC=" + roundingDiffAmountFC
                + ", roundingDiffAmountSC=" + roundingDiffAmountSC + ", cancelled=" + cancelled + ", signatureInputMessage=" + signatureInputMessage + ", signatureDigest=" + signatureDigest
                + ", certificationNumber=" + certificationNumber + ", privateKeyVersion=" + privateKeyVersion + ", controlAccount=" + controlAccount
                + ", insuranceOperation347=" + insuranceOperation347 + ", archiveNonremovableSalesQuotation=" + archiveNonremovableSalesQuotation + ", gtsChecker=" + gtsChecker
                + ", gtsPayee=" + gtsPayee + ", extraMonth=" + extraMonth + ", extraDays=" + extraDays + ", cashDiscountDateOffset=" + cashDiscountDateOffset + ", startFrom=" + startFrom
                + ", ntsApproved=" + ntsApproved + ", eTaxWebSite=" + eTaxWebSite + ", eTaxNumber=" + eTaxNumber + ", ntsApprovedNumber=" + ntsApprovedNumber
                + ", eDocGenerationType=" + eDocGenerationType + ", eDocSeries=" + eDocSeries + ", eDocNum=" + eDocNum + ", eDocExportFormat=" + eDocExportFormat + ", eDocStatus=" + eDocStatus
                + ", eDocErrorCode=" + eDocErrorCode + ", eDocErrorMessage=" + eDocErrorMessage + ", downPaymentStatus=" + downPaymentStatus + ", groupSeries=" + groupSeries
                + ", groupNumber=" + groupNumber + ", groupHandWritten=" + groupHandWritten + ", reopenOriginalDocument=" + reopenOriginalDocument
                + ", reopenManuallyClosedOrCanceledDocument=" + reopenManuallyClosedOrCanceledDocument + ", createOnlineQuotation=" + createOnlineQuotation
                + ", posEquipmentNumber=" + posEquipmentNumber + ", posManufacturerSerialNumber=" + posManufacturerSerialNumber + ", posCashierNumber=" + posCashierNumber
                + ", applyCurrentVATRatesForDownPaymentsToDraw=" + applyCurrentVATRatesForDownPaymentsToDraw + ", closingOption=" + closingOption + ", specifiedClosingDate=" + specifiedClosingDate
                + ", openForLandedCosts=" + openForLandedCosts + ", authorizationStatus=" + authorizationStatus + ", totalDiscountFC=" + totalDiscountFC + ", totalDiscountSC=" + totalDiscountSC
                + ", relevantToGTS=" + relevantToGTS + ", bplName=" + bplName + ", vatRegNum=" + vatRegNum + ", annualInvoiceDeclarationReference=" + annualInvoiceDeclarationReference
                + ", supplier=" + supplier + ", releaser=" + releaser + ", receiver=" + receiver + ", blanketAgreementNumber=" + blanketAgreementNumber + ", isAlteration=" + isAlteration
                + ", cancelStatus=" + cancelStatus + ", assetValueDate=" + assetValueDate + ", documentDelivery=" + documentDelivery + ", authorizationCode=" + authorizationCode
                ...
                + ", vehiclePlate=" + vehiclePlate + ", atDocumentType=" + atDocumentType + ", elecCommStatus=" + elecCommStatus + ", elecCommMessage=" + elecCommMessage
                + ", reuseDocumentNum=" + reuseDocumentNum + ", reuseNotaFiscalNum=" + reuseNotaFiscalNum + ", printSEPADirect=" + printSEPADirect + ", fiscalDocNum=" + fiscalDocNum
                + ", posDailySummaryNo=" + posDailySummaryNo + ", posReceiptNo=" + posReceiptNo + ", pointOfIssueCode=" + pointOfIssueCode + ", letter=" + letter
                + ", folioNumberFrom=" + folioNumberFrom + ", folioNumberTo=" + folioNumberTo + ", interimType=" + interimType + ", relatedType=" + relatedType + ", relatedEntry=" + relatedEntry
                + ", uAutorret=" + uAutorret + ", ubpcost=" + ubpcost + ", uwuid=" + uwuid + ", uTipoNota=" + uTipoNota + ", uRetefue=" + uRetefue + ", uReteIca=" + uReteIca
                + ", uok1IVAPA=" + uok1IVAPA + ", uok1IFRS=" + uok1IFRS + ", uDiseno=" + uDiseno + ", uDiseno2=" + uDiseno2 + ", uComdeco1=" + uComdeco1 + ", uComdeco2=" + uComdeco2
                + ", uVendedor1=" + uVendedor1 + ", uVendedor2=" + uVendedor2 + ", uVendedor3=" + uVendedor3 + ", uVendedor4=" + uVendedor4 + ", uVendedor5=" + uVendedor5 + ", uFactor=" + uFactor
                + ", unwrPicS=" + unwrPicS + ", unwrbRet=" + unwrbRet + ", uNwrPAut=" + uNwrPAut + ", uNwrNote=" + uNwrNote + ", uNwrTag=" + uNwrTag + ", uNwrFrgt=" + uNwrFrgt
                + ", unwrnorm=" + unwrnorm + ", uTypeExped=" + uTypeExped + ", uCreaNC=" + uCreaNC + ", uNumFact=" + uNumFact + ", uAprobado=" + uAprobado + ", uComVend1=" + uComVend1
                + ", uComVend2=" + uComVend2 + ", uComVend3=" + uComVend3 + ", uComVend4=" + uComVend4 + ", uComVend5=" + uComVend5 + ", uActCosto=" + uActCosto + ", uDocEntryLeg=" + uDocEntryLeg
                + ", uIdLineLeg=" + uIdLineLeg + ", uSerieLeg=" + uSerieLeg + ", uEsIndep=" + uEsIndep + ", uFirma=" + uFirma + ", uCedula=" + uCedula + ", uDifCode=" + uDifCode
                + ", uCatRet=" + uCatRet + ", uOrigen=" + uOrigen + ", uImprimirFactura=" + uImprimirFactura + ", uPrestashopID=" + uPrestashopID
                + ", documentApprovalRequests=" + documentApprovalRequests + ", documentLines=" + documentLines + ", documentAdditionalExpenses=" + documentAdditionalExpenses
                + ", documentSpecialLines=" + documentSpecialLines + ", taxExtension=" + taxExtension + ", addressExtension=" + addressExtension + '}';
    }
}
